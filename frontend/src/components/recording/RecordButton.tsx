...
export function RecordButton({
  ...
  return (
    <div className="flex items-center gap-6" onClick={(e) => e.stopPropagation()}>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-gold-500/0 via-gold-500/0 to-gold-500/0 group-hover:from-gold-500/10 group-hover:via-gold-500/5 group-hover:to-gold-500/10 transition-all duration-200 rounded-full" />
